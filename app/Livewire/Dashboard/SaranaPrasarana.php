...
use App\Models\User; // Ditambahkan: Walaupun tidak digunakan langsung, baik untuk konsistensi
use Carbon\Carbon;
...
class SaranaPrasarana extends Component
{
    ...
    public function mount()
    {
        ...
        Session::put('current_bidang', 'sarana_prasarana');
    }
    ...
    public function deleteArsip()
    {
        try {
            ...
            $bidangSlug = 'sarana_prasarana';
            
            // Validasi Bidang
            if ($arsip->bidang !== $bidangSlug) {
                session()->flash('error', 'Arsip ini tidak termasuk dalam Bidang Sarana & Prasarana.');
    ...
    private function getArsipData()
    {
        ...
        // Menggunakan LIKE untuk RecycleBin agar konsisten dengan Keuangan.php
        ...
        // Total Arsip (Jumlahkan ketiganya)
        ...
        // Gabung & Urutkan berdasarkan tanggal dibuat
    ...
    {
        $pageTitle = 'Bidang Sarana & Prasarana';
        if (Auth::user() && Auth::user()->role !== 'super_admin') {
            $pageTitle = 'Selamat datang, Admin Sarana & Prasarana';
        }

        // Mengganti passing data activityData menjadi chartData
        return view('livewire.dashboard.sarana-prasarana', $this->getArsipData())
            ->title($pageTitle);
    }
}