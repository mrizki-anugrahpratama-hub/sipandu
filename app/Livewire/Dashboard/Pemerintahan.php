...
class Pemerintahan extends Component
{
    ...
    public function mount()
    {
        ...
        Session::put('current_bidang', 'pemerintahan');
    }
    ...
    public function deleteArsip()
    {
        try {
            ...
            $bidangSlug = 'pemerintahan';
            
            // Validasi Bidang
            if ($arsip->bidang !== $bidangSlug) {
                session()->flash('error', 'Arsip ini tidak termasuk dalam Bidang pemerintahan.');
    ...
    {
        $pageTitle = 'Bidang Pemerintahan';
        if (Auth::user() && Auth::user()->role !== 'super_admin') {
            $pageTitle = 'Selamat datang, Admin Pemerintahan';
        }

        // Mengganti passing data activityData menjadi chartData
        return view('livewire.dashboard.pemerintahan', $this->getArsipData())
            ->title($pageTitle);
    }
}