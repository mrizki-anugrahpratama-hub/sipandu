...
@php
    ...
    $bidangSlug = 'kemasyarakatan'; /* <-- DIUBAH MENJADI KEMASYARAKATAN */
    $currentBidangTitle = 'Bidang Kemasyarakatan'; /* <-- DIUBAH MENJADI KEMASYARAKATAN */
    ...
    $recentArsip = $recentArsip ?? [
        (object)['nama_tampilan' => 'Notulen Rapat Bulanan', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Super Admin'], 'jenis_arsip_label' => 'AKTIF', 'jenis_arsip' => 'aktif', 'created_at' => now()->subHour(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Laporan Pertanggungjawaban Keuangan', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Admin Keu'], 'jenis_arsip_label' => 'VITAL', 'jenis_arsip' => 'vital', 'created_at' => now()->subDay(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Data Survey Kepuasan Publik 2024', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staff Humas'], 'jenis_arsip_label' => 'INAKTIF', 'jenis_arsip' => 'inaktif', 'created_at' => now()->subDays(2), 'edit_route' => '#'],
    ];
