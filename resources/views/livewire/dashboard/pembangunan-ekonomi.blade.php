...
@php
    ...
    $bidangSlug = 'pembangunan_ekonomi'; /* <-- DIUBAH MENJADI PEMBANGUNAN EKONOMI */
    $currentBidangTitle = 'Bidang Pembangunan Ekonomi'; /* <-- DIUBAH MENJADI PEMBANGUNAN EKONOMI */
    ...
    $recentArsip = $recentArsip ?? [
        (object)['nama_tampilan' => 'Notulen Rapat Paripurna', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Sekretaris Dewan'], 'jenis_arsip_label' => 'AKTIF', 'jenis_arsip' => 'aktif', 'created_at' => now()->subHour(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Keputusan Walikota/Bupati No. 12', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Kabag Hukum'], 'jenis_arsip_label' => 'VITAL', 'jenis_arsip' => 'vital', 'created_at' => now()->subDay(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Pengajuan Anggaran Tahunan', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staff Perencanaan'], 'jenis_arsip_label' => 'INAKTIF', 'jenis_arsip' => 'inaktif', 'created_at' => now()->subDays(2), 'edit_route' => '#'],
    ];
