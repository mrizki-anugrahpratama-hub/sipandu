...
@php
    ...
    $bidangSlug = 'keuangan'; /* <-- DIUBAH MENJADI KEUANGAN */
    $currentBidangTitle = 'Sub. Bagian Keuangan'; /* <-- DIUBAH MENJADI KEUANGAN */
    ...
    $recentArsip = $recentArsip ?? [
        (object)['nama_tampilan' => 'Laporan Realisasi Anggaran Bulan Ini', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Bendahara'], 'jenis_arsip_label' => 'AKTIF', 'jenis_arsip' => 'aktif', 'created_at' => now()->subHour(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'SPJ Perjalanan Dinas Luar Daerah', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staf Keuangan'], 'jenis_arsip_label' => 'VITAL', 'jenis_arsip' => 'vital', 'created_at' => now()->subDay(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Bukti Setor Pajak PPh 21', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Admin Pajak'], 'jenis_arsip_label' => 'INAKTIF', 'jenis_arsip' => 'inaktif', 'created_at' => now()->subDays(2), 'edit_route' => '#'],
    ];
