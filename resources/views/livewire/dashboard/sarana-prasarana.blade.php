...
@php
    ...
    $bidangSlug = 'sarana_prasarana'; /* <-- DIUBAH MENJADI SARANA & PRASARANA */
    $currentBidangTitle = 'Bidang Sarana & Prasarana'; /* <-- DIUBAH MENJADI SARANA & PRASARANA */
    ...
    $recentArsip = $recentArsip ?? [
        (object)['nama_tampilan' => 'Daftar Inventaris Kendaraan Dinas 2025', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staf Aset'], 'jenis_arsip_label' => 'AKTIF', 'jenis_arsip' => 'aktif', 'created_at' => now()->subHour(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Laporan Pemeliharaan Gedung Triwulan I', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Kabag Umum'], 'jenis_arsip_label' => 'VITAL', 'jenis_arsip' => 'vital', 'created_at' => now()->subDay(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Pengajuan Pengadaan Alat Tulis Kantor', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staf Logistik'], 'jenis_arsip_label' => 'INAKTIF', 'jenis_arsip' => 'inaktif', 'created_at' => now()->subDays(2), 'edit_route' => '#'],
    ];
