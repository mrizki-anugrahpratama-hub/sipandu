...
@php
    ...
    $bidangSlug = 'umum_kepegawaian'; /* <-- DIUBAH MENJADI UMUM & KEPEGAWAIAN */
    $currentBidangTitle = 'Sub. Umum & Kepegawaian'; /* <-- DIUBAH MENJADI UMUM & KEPEGAWAIAN */
    ...
    $recentArsip = $recentArsip ?? [
        (object)['nama_tampilan' => 'Daftar Hadir Rapat Mingguan', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staf TU'], 'jenis_arsip_label' => 'AKTIF', 'jenis_arsip' => 'aktif', 'created_at' => now()->subHour(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'SK Mutasi Pegawai 2025', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Kabid Kepegawaian'], 'jenis_arsip_label' => 'VITAL', 'jenis_arsip' => 'vital', 'created_at' => now()->subDay(), 'edit_route' => '#'],
        (object)['nama_tampilan' => 'Surat Pengantar Dinas Luar', 'bidang' => $bidangSlug, 'user' => (object)['name' => 'Staf Umum'], 'jenis_arsip_label' => 'INAKTIF', 'jenis_arsip' => 'inaktif', 'created_at' => now()->subDays(2), 'edit_route' => '#'],
    ];
