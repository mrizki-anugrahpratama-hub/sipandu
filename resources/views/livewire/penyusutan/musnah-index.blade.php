<div class="dashboard-container livewire-scope">
    ...
    <x-slot name="header">
        <div class="welcome-title-group" style="display: flex; flex-direction: column; align-items: flex-start; width: 100%;">
            ...
            <h1 class="dashboard-header__title">Olah Arsip Musnah</h1>
    ...
    class="livewire-scope"> 
        ...
        <section class="card animated-card">
            ...
            <div class="table-actions-bar">
                ...
                {{-- Tombol Ekspor (Disesuaikan dengan pilihan checkbox) --}}
            ...
            <div class="filter-container" x-show="isFilterSectionOpen" x-transition.duration.300ms style="display: none;">
                <div class="filter-container-header">
                    <h3><i class="bi bi-filter"></i> Filter Arsip Musnah</h3>
                </div>
                ...
                <table class="data-table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style="white-space: nowrap; min-width: 120px; vertical-align: middle;" rowspan="2">
                                {{ $activeTab === 'selesai' ? 'TANGGAL MUSNAH' : 'TANGGAL MUSNAH' }}
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr class="clickable-row">
                            ...
                            {{-- TANGGAL TANPA JAM --}}
                            <td class="text-center">
                                <span class="font-semibold" style="color: var(--color-red);">
                                     @if ($activeTab === 'selesai')
                                         {{ $arsip->tanggal_eksekusi ? \Carbon\Carbon::parse($arsip->tanggal_eksekusi)->format('d M Y') : '-' }}
                                     @else
                                         {{ $arsip->tgl_retensi_berakhir ? \Carbon\Carbon::parse($arsip->tgl_retensi_berakhir)->format('d M Y') : '-' }}
                                     @endif
                                </span>
                            </td>
                        ...
                        <tr>
                            <td colspan="14" class="empty-state-cell"> 
                                <div class="empty-state-content">
                                    <i class="bi bi-fire empty-state-icon-large"></i>
                                    <span class="empty-state-title">Data Arsip Musnah Tidak Ditemukan</span>
                                    <span class="empty-state-message">
                                        Tidak ada arsip yang tercatat sebagai musnah.
                                    </span>
                                </div>
                            </td>
                        </tr>
